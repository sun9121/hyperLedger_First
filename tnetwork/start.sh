...
# docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org1.ict.com/msp" peer0.org1.ict.com peer channel update -f /etc/hyperledger/configtx/Org1MSPanchors.tx -c channel1 -o orderer.ict.com:7050
# sleep 3 

# docker exec -e "CORE_PEER_LOCALMSPID=Org3MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org3.ict.com/msp" peer0.org3.ict.com peer channel update -f /etc/hyperledger/configtx/Org3MSPanchors.tx -c channel1 -o orderer.ict.com:7050
# sleep 3 

# docker exec -e "CORE_PEER_LOCALMSPID=Org2MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org2.ict.com/msp" peer0.org2.ict.com peer channel update -f /etc/hyperledger/configtx/Ch2Org2MSPanchors.tx -c channel2 -o orderer.ict.com:7050
# sleep 3 

# docker exec -e "CORE_PEER_LOCALMSPID=Org3MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org3.ict.com/msp" peer0.org3.ict.com peer channel update -f /etc/hyperledger/configtx/Ch2Org3MSPanchors.tx -c channel2 -o orderer.ict.com:7050
# sleep 3 

docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org1.ict.com/msp" peer0.org1.ict.com peer channel list
docker exec -e "CORE_PEER_LOCALMSPID=Org2MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org2.ict.com/msp" peer0.org2.ict.com peer channel list
docker exec -e "CORE_PEER_LOCALMSPID=Org3MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org3.ict.com/msp" peer0.org3.ict.com peer channel list
